...
export function RolesPermissionsHub({
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-[260px_1fr] overflow-hidden rounded-[10px] border border-stone-line bg-stone-surface">
        <RoleListRail
          items={railItems}
          activeRole={role}
        ...
        <main className="min-w-0 overflow-auto px-9 pb-20 pt-7">
          <header className="mb-5 flex flex-wrap items-start justify-between gap-4 border-b border-stone-line pb-4.5">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2.5">
                <span className="text-[24px] font-semibold tracking-[-0.02em] text-stone-ink">
                  {capitalize(role)}
                </span>
                ...
                {highlightRole === role ? (
                  <span className="rounded-full bg-stone-line2 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-stone-muted">
                    Current role
                  </span>
                ) : null}
              </div>
              <p className="mt-1 max-w-[640px] text-[13px] text-stone-muted">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={cn(
                  "rounded-md border border-stone-line bg-stone-surface px-3.5 py-2 text-[13px] font-medium text-stone-ink2",
              ...
              <button
                ...
                className={cn(
                  "rounded-md border border-stone-line bg-stone-surface px-3.5 py-2 text-[13px] font-medium",
          ...
          {isSystem && mode === "edit" ? (
            <p className="mt-6 text-[12px] text-stone-muted">
...
function ModeToggle({ mode, onChange }: { mode: Mode; onChange: (m: Mode) => void }) {
  return (
    <div
      ...
      className="inline-flex rounded-lg bg-stone-line2 p-[3px]"
    >
