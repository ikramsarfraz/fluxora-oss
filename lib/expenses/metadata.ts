/**
 * Pure, client-safe metadata for expenses. No server-only imports here so
 * this module can be used in both Server and Client Components without
...
/**
 * Returns `true` when the given role is allowed to create, edit, or delete
 * expenses. Safe to call from client code.
 */
