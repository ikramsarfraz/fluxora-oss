 ...
 *
 * The type definitions used to live here; they moved to `./types` once the
 * tour system grew to support multiple tours (orders-new, bills-new, …).
 * Re-exported below to keep existing imports working.
 */
