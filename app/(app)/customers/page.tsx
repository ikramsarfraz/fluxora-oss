...
export default function Customers() {
  ...
  const { data: customers, isLoading, error: loadError } = useQuery({
    queryKey: ["customers"],
  ...
  return (
    <>
      ...
      {/* Add customer form */}
      <section className="card form-card" aria-labelledby="add-customer-heading">
      ...
      {/* Customer list */}
      <section className="table-section" aria-labelledby="customers-table-heading">
        <h2 id="customers-table-heading" style={{ fontSize: "1.1rem", marginBottom: "0.75rem" }}>All customers</h2>
                  ...
                  <td>
                    {editId === c.id ? (
                      ...
                      <>
                        ...
                        >
                          {deleteCustomer.isPending && deleteCustomer.variables === c.id ? "…" : "Delete"}
                        </button>
                      </>
                    )}
                  </td>
