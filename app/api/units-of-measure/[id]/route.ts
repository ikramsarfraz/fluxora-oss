...
export async function GET(
  ...
  try {
    ...
    const unit = await getUnitOfMeasureById(id);
...
export async function PATCH(
  ...
  try {
    ...
    const unit = await updateUnitOfMeasure(id, {
      name: body.name?.trim(),
      abbreviation: body.abbreviation !== undefined ? (body.abbreviation?.trim() || null) : undefined,
    ...
    console.error(err);
    const message = err instanceof Error ? err.message : "Failed to update unit of measure";
