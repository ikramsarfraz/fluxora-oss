  ...
  return (
    <footer className="relative border-t border-[oklch(0.90_0.02_230)] px-4 py-10 sm:px-6 sm:py-12 lg:px-8" style={{ background: "oklch(0.98 0.005 230)" }}>
      ...
      <div className="relative mx-auto max-w-[1120px]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-12 lg:gap-16">
            <div>
              ...
              <div className="flex flex-col gap-2 text-[0.85rem] text-[oklch(0.50_0.02_230)] sm:gap-2.5">
                ...
                <a href="#" className="transition-colors hover:text-[oklch(0.30_0.03_230)]">Changelog</a>
              </div>
            </div>
            <div>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-[oklch(0.90_0.02_230)] pt-6 sm:mt-12 sm:flex-row sm:items-center sm:justify-between sm:pt-8">
          <div className="flex flex-col gap-1">
            <div className="text-[0.78rem] text-[oklch(0.50_0.02_230)] sm:text-[0.8rem]">© 2026 Fluxora, Inc. All rights reserved.</div>
            <div className="flex items-center gap-1.5 text-[0.72rem] text-[oklch(0.55_0.02_230)] sm:text-[0.75rem]">
              Built by 
              <a href="https://pelzersolutions.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-[oklch(0.45_0.12_195)] transition-colors hover:text-[oklch(0.35_0.14_195)]">
                Pelzer Solutions
              </a>
            </div>
          </div>
