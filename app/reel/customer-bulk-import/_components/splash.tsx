...
import { ArrowRight, Check, Clock, FileSpreadsheet } from "lucide-react";

import { Logomark } from "@/components/brand/logomark";
import { cn } from "@/lib/utils";

// Opening + closing splashes, and the chapter-pill overlays that punctuate
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Customer bulk import</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        ...
        >
          ...
          to system —
          <br />
          <span className="text-forest-mid">in one drop.</span>
        </motion.h1>
        ...
        >
          Watch what your customer book looks like before Fluxora — then watch
          eighteen customers import in under five seconds.
        </motion.p>
...
export function ChapterPill({
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-50 flex items-center justify-center bg-page/80 backdrop-blur-sm"
    >
      <motion.div
        ...
        className={cn(
          "flex items-center gap-4 rounded-full border bg-card-warm/95 px-5 py-3 shadow-2xl backdrop-blur",
          tone === "forest"
            ? "border-forest-tint-deep/70"
            : "border-warning-border/70",
        )}
      >
        <span
          className={cn(
            "flex size-8 items-center justify-center rounded-full text-[13px] font-bold text-card-warm",
            tone === "forest" ? "bg-forest-mid" : "bg-warning-fg",
          )}
        >
          {index}
        </span>
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        <motion.h1
          ...
          className="max-w-[640px] font-serif text-[40px] font-medium leading-[1.1] tracking-tight text-ink md:text-[48px]"
        >
          Stop typing customers.
          <br />
          <span className="text-forest-mid">Start importing them.</span>
        </motion.h1>
        ...
        >
          <Stat icon={Clock} label="Manual" value="≈ 36 min" muted />
    ...
    <div className="flex flex-col items-center gap-1">
      ...
      <div
        className={cn(
          ...
          highlight && "text-forest-mid",
          muted && "text-subtle line-through decoration-2",
