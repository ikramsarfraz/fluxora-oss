    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Onboarding · first run</span>
          <span className="size-1 rounded-full bg-info-fg" />
        </motion.div>
        <motion.h1
        ...
        >
          ...
          <br />
          <span className="text-info-fg">in under two minutes.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Pick a subdomain. Name your workspace. Bring your team. Then start
          turning orders into invoices.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-4 rounded-full border border-info-border/80 bg-card-warm/95 px-5 py-3 shadow-2xl backdrop-blur"
      >
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          Workspace live.
          <br />
          <span className="text-info-fg">Team invited. Ready to ship.</span>
        </motion.h1>
        <motion.div
        ...
        >
          <Stat icon={Clock} label="Setup time" value="1 min 48 sec" highlight />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
