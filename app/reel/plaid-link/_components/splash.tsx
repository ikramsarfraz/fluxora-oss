...
import { ArrowRight, Check, Landmark, Repeat } from "lucide-react";
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at center, color-mix(in oklch, var(--color-info-bg) 65%, transparent) 0%, transparent 70%)",
        }}
      />
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-info-fg"
        >
          <span className="size-1 rounded-full bg-info-fg" />
          <span>Plaid · bank linking</span>
          <span className="size-1 rounded-full bg-info-fg" />
        </motion.div>
        <motion.h1
        ...
        >
          ...
          <br />
          <span className="text-info-fg">Forever.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Plug into your bank through Plaid. Fluxora pulls transactions on a
          schedule and auto-matches them to invoices, bills, and expenses.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <span className="relative flex size-2">
            <span className="absolute inset-0 animate-ping rounded-full bg-info-fg/40" />
            <span className="relative size-2 rounded-full bg-info-fg" />
          </span>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-4 rounded-full border border-info-border/70 bg-card-warm/95 px-5 py-3 shadow-2xl backdrop-blur"
      >
        <span className="flex size-8 items-center justify-center rounded-full bg-info-fg text-[13px] font-bold text-card-warm">
          {index}
        </span>
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at center, color-mix(in oklch, var(--color-info-bg) 70%, transparent) 0%, transparent 70%)",
        }}
      />
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        <motion.div
          ...
          className="flex size-14 items-center justify-center rounded-full bg-info-bg text-info-fg"
        >
        ...
        >
          One bank link.
          <br />
          <span className="text-info-fg">A lifetime of clean reconciliation.</span>
        </motion.h1>
        <motion.div
        ...
        >
          <Stat icon={Landmark} label="Bank linked" value="Chase · checking" />
          <Divider />
          <Stat icon={Repeat} label="Sync" value="daily · auto" highlight />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.14em] text-subtle">
        <Icon
          className={cn("size-3", highlight ? "text-info-fg" : "text-subtle")}
          strokeWidth={2}
        />
        {label}
      </div>
      <div
        className={cn(
          ...
          highlight ? "text-info-fg" : "text-ink",
        )}
      >
        {value}
      </div>
