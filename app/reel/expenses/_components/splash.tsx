...
import { ArrowRight, Check, Receipt, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at center, color-mix(in oklch, var(--color-warning-bg) 65%, transparent) 0%, transparent 70%)",
        }}
      />
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          Drop the receipt.
          <br />
          <span className="text-warning-fg">It hits the P&amp;L by lunch.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Snap a photo, drop it in. Fluxora reads vendor, total, and category
          straight from the image — and books the entry against the right
          account.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          <Stat icon={Receipt} label="Capture" value="6 sec" />
          <Divider />
          <Stat icon={Sparkles} label="AI confidence" value="94%" highlight />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
