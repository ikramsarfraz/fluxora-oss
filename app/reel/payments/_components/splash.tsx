    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-success-fg"
        >
          <span className="size-1 rounded-full bg-success-fg" />
          <span>Payments · auto-applied</span>
          <span className="size-1 rounded-full bg-success-fg" />
        </motion.div>
        ...
        >
          ...
          Matched to invoices.
          <br />
          <span className="text-success-fg">Aging clears itself.</span>
        </motion.h1>
        ...
        >
          Record one payment. Fluxora applies it to the oldest open invoices,
          updates aging in real time, and books any overpayment as credit.
        </motion.p>
        ...
        >
          <span className="relative flex size-2">
            <span className="absolute inset-0 animate-ping rounded-full bg-success-fg/40" />
            <span className="relative size-2 rounded-full bg-success-fg" />
          </span>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-4 rounded-full border border-success-border/80 bg-card-warm/95 px-5 py-3 shadow-2xl backdrop-blur"
      >
        <span className="flex size-8 items-center justify-center rounded-full bg-success-fg text-[13px] font-bold text-card-warm">
          {index}
        </span>
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          ...
          <span className="text-success-fg">
            Three invoices closed. Aging current.
          </span>
        </motion.h1>
        ...
        >
          <Stat icon={Wallet} label="Applied" value="$4,880" />
          <Divider />
          <Stat icon={Zap} label="FIFO" value="oldest-first" highlight />
        </motion.div>
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.14em] text-subtle">
        <Icon
          className={cn("size-3", highlight ? "text-success-fg" : "text-subtle")}
          strokeWidth={2}
        />
        {label}
      </div>
      <div
        className={cn(
          "font-serif text-[24px] font-medium leading-none",
