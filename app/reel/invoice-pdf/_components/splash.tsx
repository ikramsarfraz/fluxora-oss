    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Invoice PDF · branded send</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        <motion.h1
        ...
        >
          ...
          Their inbox.
          <br />
          <span className="text-forest-mid">One click.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Set your letterhead once. Every invoice — generated, branded, and
          delivered to the customer&apos;s inbox in seconds.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          Invoice sent.
          <br />
          <span className="text-forest-mid">In your brand. To their inbox.</span>
        </motion.h1>
        <motion.div
        ...
        >
          <Stat icon={FileText} label="PDF" value="generated · branded" />
          <Divider />
          <Stat icon={Mail} label="Delivered" value="in 4 seconds" highlight />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
