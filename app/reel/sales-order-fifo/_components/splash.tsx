    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Sales orders · FIFO inventory</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        ...
        >
          ...
          Pull the stock.
          <br />
          <span className="text-forest-mid">Watch FIFO work.</span>
        </motion.h1>
        ...
        >
          From phone call to invoice in ninety seconds. Lots allocate
          oldest-first, prices land on the customer&apos;s tier, margin is live.
        </motion.p>
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          Order entered.
          <br />
          <span className="text-forest-mid">Stock pulled. Invoice ready.</span>
        </motion.h1>
        ...
        >
          <Stat icon={Sparkles} label="3 lines" value="$2,288.00" />
          <Divider />
          <Stat icon={Clock} label="FIFO pulled" value="6 lots" />
          <Divider />
          <Stat icon={Sparkles} label="Margin" value="42.7%" highlight />
        </motion.div>
