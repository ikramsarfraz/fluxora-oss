    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Roles · row-level access</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        <motion.h1
        ...
        >
          Everyone in.
          <br />
          <span className="text-forest-mid">Only what they need.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Design roles to match how your team really works. The same workspace
          shows the warehouse crew lots and pick lists — and your CFO the
          full P&amp;L.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-4 rounded-full border border-forest-tint-deep/70 bg-card-warm/95 px-5 py-3 shadow-2xl backdrop-blur"
      >
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          Role-aware app.
          <br />
          <span className="text-forest-mid">Server-enforced. Audit-logged.</span>
        </motion.h1>
        <motion.div
        ...
        >
          <Stat icon={Users} label="Roles" value="custom · per-tenant" />
          <Divider />
          <Stat icon={ShieldCheck} label="Enforcement" value="server-side" highlight />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.14em] text-subtle">
        <Icon
          className={cn("size-3", highlight ? "text-forest-mid" : "text-subtle")}
          strokeWidth={2}
        />
        {label}
      </div>
