    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Dashboard · morning glance</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        ...
        >
          ...
          Know the day —
          <br />
          <span className="text-forest-mid">in five seconds.</span>
        </motion.h1>
        ...
        >
          Revenue, margin, aging, inventory at risk, today&apos;s wins — every
          number you check first thing, in one glance.
        </motion.p>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          <Stat icon={LayoutDashboard} label="One screen" value="9 metrics" />
          <Divider />
          <Stat icon={Clock} label="Refresh" value="on load" />
          <Divider />
          <Stat
            icon={BarChart3}
            label="Drill"
