    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-7 px-8 text-center">
        ...
        >
          ...
          <span>Inventory · lot ledger</span>
          <span className="size-1 rounded-full bg-forest-mid" />
        </motion.div>
        ...
        >
          ...
          <br />
          <span className="text-forest-mid">Down to the lot.</span>
        </motion.h1>
        ...
        >
          Every lot, every move, every dollar of stock — traceable from
          receipt to ship, with expiry warnings before they bite.
        </motion.p>
...
export function ChapterPill({
  ...
  return (
    ...
    >
      ...
      >
        <span className="flex size-8 items-center justify-center rounded-full bg-forest-mid text-[13px] font-bold text-card-warm">
          {index}
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center">
        ...
        >
          Every lot. Every move.
          <br />
          <span className="text-forest-mid">Every dollar traceable.</span>
        </motion.h1>
        ...
        >
          <Stat icon={Boxes} label="On hand" value="$84,212" />
          <Divider />
          <Stat icon={Sparkles} label="At risk caught" value="4 lots" highlight />
          <Divider />
          <Stat icon={History} label="Movements" value="audit-trailed" />
        </motion.div>
    ...
    <div className="flex flex-col items-center gap-1">
      ...
      <div
        className={cn(
          ...
          highlight ? "text-forest-mid" : "text-ink",
        )}
      >
        {value}
      </div>
